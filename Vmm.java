...
public class Vmm {
	...
	/** The vmlist. */
	private static List<Vmm> vmlist;

	private static List<Vmm> createVM(int userId, int vms, int idShift) {
		//Creates a container to store VMs. This list is passed to the broker later
		LinkedList<Vmm> list = new LinkedList<Vmm>();
		...
		for(int i=0;i<vms;i++){
			vm[i] = new Vmm(idShift + i, userId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			list.add(vm[i]);
		}
